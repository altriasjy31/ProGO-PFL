...
args = {'device':torch.device('cuda' if torch.cuda.is_available() else 'cpu'),
        'go_name': 'mf',
        'model_path':prj_root + '/models/hgat_hgtsampler' + 'mf',
        'epoch':20,
        'batch_size':16,
        'patience':10,
        'lr':0.01,
